...
create role usuariodml;
grant usage on schema spotify_db to usuariodml;
create user usuariodml_1 with password 'senha' in role usuariodml;

grant select, update, delete, insert on spotify_db.album to usuariodml;
grant select, update, delete, insert on spotify_db.artist to usuariodml;
grant select, update, delete, insert on spotify_db.playlist to usuariodml;
grant select, update, delete, insert on spotify_db.track to usuariodml;
grant select, update, delete, insert on spotify_db.track_album to usuariodml;
grant select, update, delete, insert on spotify_db.track_artist to usuariodml;
grant select, update, delete, insert on spotify_db.track_playlist to usuariodml;

grant select on spotify_db.musicas_longas to usuariodml;
grant select on spotify_db.top10MusicasporPopularidade to usuariodml;
grant select on spotify_db.top10ArtistasporPopularidade to usuariodml;
grant select on spotify_db.top10ArtistasporSeguidores to usuariodml;
grant select on spotify_db.albuns_explicit to usuariodml;
grant select on spotify_db.artistas_dancantes_view to usuariodml;
grant select on spotify_db.albuns_energeticos_view to usuariodml;
grant select on spotify_db.album_acustico_popularidade_view to usuariodml;
grant select on spotify_db.artistas_por_genero to usuariodml;
grant select on spotify_db.musicas_instrumentais to usuariodml;
